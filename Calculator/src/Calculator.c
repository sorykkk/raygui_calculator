...
bool GuiButtonKeyPressed(Rectangle bounds, const char *text)// Modified function from raygui.h that is applied when keyboard button is pressed
{
    GuiControlState state = guiState;
    bool pressed = false;

    if ((state != GUI_STATE_DISABLED) && !guiLocked) state = GUI_STATE_PRESSED;// Update control
...
Rectangle layoutRecs[27] =
{
    ...
    (Rectangle){ 190, 460, 86, 60 }     // 26 Button: ButtonPoint
};
//------------------------------------------------------------------------------------
...
int main()
{
    ...
    {
        // Draw controls // with additional effect when control button is accessed via keyboard button
        //----------------------------------------------------------------------------------
        BeginDrawing();
        ...
        if (GuiButton(layoutRecs[3], "C")) ButtonClear();
        else if(((IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT)) && IsKeyPressed(KEY_DELETE)))
        {
            GuiButtonKeyPressed(layoutRecs[3], "C");
            ButtonClear();
        }
        
        if (GuiButton(layoutRecs[4], "÷")) ButtonDivision();
        else if((IsKeyPressed(KEY_SLASH) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))) || IsKeyPressed(KEY_KP_DIVIDE))
        {
            GuiButtonKeyPressed(layoutRecs[4], "÷");
            ButtonDivision();
        }
        
        if (GuiButton(layoutRecs[5], "x")) ButtonMultiplication();
        else if(((IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT)) && IsKeyPressed(KEY_EIGHT)) || IsKeyPressed(KEY_KP_MULTIPLY))
        {
            GuiButtonKeyPressed(layoutRecs[5], "x");
            ButtonMultiplication();
        }
        
        if (GuiButton(layoutRecs[6], "-")) ButtonSubstraction();
        else if((IsKeyPressed(KEY_MINUS) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))) || IsKeyPressed(KEY_KP_SUBTRACT)) 
        {
            GuiButtonKeyPressed(layoutRecs[6], "-");
            ButtonSubstraction();
        }
        
        if (GuiButton(layoutRecs[7], "7")) Button7();
        else if((IsKeyPressed(KEY_SEVEN) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))) || IsKeyPressed(KEY_KP_7))
        {
            GuiButtonKeyPressed(layoutRecs[7], "7");
            Button7();
        }
        
        if (GuiButton(layoutRecs[8], "8")) Button8();
        else if(((IsKeyPressed(KEY_EIGHT) || IsKeyPressed(KEY_KP_8)) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))))
        {
            GuiButtonKeyPressed(layoutRecs[8], "8");
            Button8();
        }
        
        if (GuiButton(layoutRecs[9], "9")) Button9();
        else if((IsKeyPressed(KEY_NINE) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))) || IsKeyPressed(KEY_KP_9))
        {
            GuiButtonKeyPressed(layoutRecs[9], "9");
            Button9();
        }
        
        if (GuiButton(layoutRecs[10], "+")) ButtonAdition();
        else if(((IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT)) && IsKeyPressed(KEY_EQUAL)) || IsKeyPressed(KEY_KP_ADD))
        {
            GuiButtonKeyPressed(layoutRecs[10], "+");
            ButtonAdition();
        }
        
        if (GuiButton(layoutRecs[11], "4")) Button4();
        else if((IsKeyPressed(KEY_FOUR) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))) || IsKeyPressed(KEY_KP_4))
        {
            GuiButtonKeyPressed(layoutRecs[11], "4");
            Button4();
        }
        
        if(GuiButton(layoutRecs[12], "5")) Button5();
        else if(((IsKeyPressed(KEY_FIVE) || IsKeyPressed(KEY_KP_5)) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))))
        {
            GuiButtonKeyPressed(layoutRecs[12], "5");
            Button5();
        }
        
        if (GuiButton(layoutRecs[13], "6")) Button6();
        else if((IsKeyPressed(KEY_SIX) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))) || IsKeyPressed(KEY_KP_6))
        {
            GuiButtonKeyPressed(layoutRecs[13], "6");
            Button6();
        }
        
        if (GuiButton(layoutRecs[14], "1")) Button1();
        else if ((IsKeyPressed(KEY_ONE) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))) || IsKeyPressed(KEY_KP_1))
        {
            GuiButtonKeyPressed(layoutRecs[14], "1");
            Button1();
        }
        
        if (GuiButton(layoutRecs[15], "2")) Button2();
        else if( (IsKeyPressed(KEY_TWO) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))) || IsKeyPressed(KEY_KP_2))
        {
            GuiButtonKeyPressed(layoutRecs[15], "2");
            Button2();
        }
        
        if (GuiButton(layoutRecs[16], "3")) Button3();
        else if((IsKeyPressed(KEY_THREE) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))) || IsKeyPressed(KEY_KP_3))
        {
            GuiButtonKeyPressed(layoutRecs[16], "3");
            Button3();
        }
        
        if (GuiButton(layoutRecs[17], "=")) ButtonEnter();
        else if(IsKeyPressed(KEY_KP_ENTER) || IsKeyPressed(KEY_ENTER) || IsKeyPressed(KEY_KP_EQUAL) || (IsKeyPressed(KEY_EQUAL) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))))
        {
            GuiButtonKeyPressed(layoutRecs[17], "=");
            ButtonEnter();
        }
        
        if (GuiButton(layoutRecs[18], "0")) Button0();
        else if((IsKeyPressed(KEY_ZERO) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT))) || IsKeyPressed(KEY_KP_0))
        {
            GuiButtonKeyPressed(layoutRecs[18], "0");
            Button0();
        }
        
        if (GuiButton(layoutRecs[19], "%")) ButtonPercent();
        else if((IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT)) && IsKeyPressed(KEY_FIVE))
        {
            GuiButtonKeyPressed(layoutRecs[19], "%");
            ButtonPercent();
        }
        
        if (GuiButton(layoutRecs[20], "CE")) ButtonClearCell();
        else if(IsKeyPressed(KEY_DELETE) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT)))
        {
            GuiButtonKeyPressed(layoutRecs[20], "CE");
            ButtonClearCell();
        }
        
        if (GuiButton(layoutRecs[21], "<-")) ButtonBackSpace();
        else if(IsKeyPressed(KEY_BACKSPACE) && !(IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT)))
        {
            GuiButtonKeyPressed(layoutRecs[21], "<-");
            ButtonBackSpace();
        }
        ...
        if (GuiButton(layoutRecs[24], "x^(1/2)")) ButtonSqrtX();
        else if(IsKeyPressed(KEY_TWO) && (IsKeyDown(KEY_LEFT_SHIFT) || IsKeyDown(KEY_RIGHT_SHIFT)))
        {
            GuiButtonKeyPressed(layoutRecs[24], "x^(1/2)");
            ButtonSqrtX();
        }
        
        if (GuiButton(layoutRecs[25], "+/-")) ButtonPlusMinus();
        
        if (GuiButton(layoutRecs[26], ".")) ButtonPoint();
        else if(IsKeyPressed(KEY_PERIOD) || IsKeyPressed(KEY_KP_DECIMAL))
        {
            GuiButtonKeyPressed(layoutRecs[26], ".");
            ButtonPoint();
        }
...
{
    if(!ActivePoint) DisplayNumber('.');//if in string is not already present any point then display point to string in bigtextbox
